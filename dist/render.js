...
function renderBody(outcome, previous, repository, reportUrl, options) {
    ...
    if (outcome.diagnostics)
        lines.push(`Optional compatibility follow-up: **${outcome.diagnostics.health}**; ${outcome.diagnostics.completed}/${outcome.diagnostics.eligible} findings assessed in ${outcome.diagnostics.requests} logical request attempts. Follow-up results do not change findings or gate decisions.`, "");
